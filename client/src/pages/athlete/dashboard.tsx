...
export default function AthleteDashboard() {
  ...
  const getVerificationBadge = (level: string) => {
    const badges = {
      bronze: {
        className: "bg-gradient-to-r from-orange-400 to-orange-600 text-white border-0 animate-pulse-slow",
        icon: Medal,
        label: "Bronze"
      },
      silver: {
        className: "bg-gradient-to-r from-gray-300 to-gray-500 text-white border-0 animate-pulse-slow",
        icon: Star,
        label: "Prata"
      },
      gold: {
        className: "bg-gradient-to-r from-yellow-400 to-yellow-600 text-black border-0 animate-pulse-slow shadow-lg shadow-yellow-500/30",
        icon: Crown,
        label: "Ouro"
      },
      platinum: {
        className: "bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 text-white border-0 animate-pulse-slow shadow-xl shadow-purple-500/40",
        icon: Trophy,
        label: "Platina"
      }
    };
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-2">
                {getVerificationBadge(athlete.verificationLevel || realisticStats.verificationLevel)}
