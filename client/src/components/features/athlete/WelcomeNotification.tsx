...
export function WelcomeNotification({ athleteName, streakDays, scoutsWatching, percentileChange = 2 }: WelcomeNotificationProps) {
  ...
  return (
    <div className={`fixed top-20 right-4 z-50 transform transition-all duration-500 ${isClosing ? 'translate-x-full opacity-0' : 'translate-x-0 opacity-100'}`}>
      <Card className="w-80 bg-white shadow-2xl border-2 border-verde-brasil overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-verde-brasil/5 to-transparent pointer-events-none" />
        ...
        <div className="relative p-4">
          ...
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-verde-brasil to-green-600 rounded-full flex items-center justify-center flex-shrink-0">
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            
            <div className="flex-1 pt-1">
              <h3 className="font-bebas text-lg text-gray-900 mb-1">
