...
interface UserTypeModalPropsV2 {
  open: boolean;
...
export function UserTypeModalLegacy({ isOpen, onClose, selectedType }: UserTypeModalProps) {
...
export default UserTypeModalLegacy;

// Named export for new auth flow
export function UserTypeModal({ open, onOpenChange, onSelectType }: UserTypeModalPropsV2) {
  const [localSelectedType, setLocalSelectedType] = useState<"athlete" | "scout" | null>(null);
